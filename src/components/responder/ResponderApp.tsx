...
export const ResponderApp: React.FC = () => {
  ...
  // Filter tasks for Rahim / active triage queue
  ...
  // Active task (prioritizing GV-1042 for primary showcase)
  const currentTask = myTasks.find(t => t.id === 'GV-1042') || myTasks[0];
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2 pt-1">
                ...
                {currentTask.status === 'CLOSED' && (
                  <div className="p-3 rounded-2xl bg-emerald-950/60 border border-emerald-800/60 text-center space-y-1">
                    <Sparkles className="w-5 h-5 text-emerald-400 mx-auto" />
                    <div className="font-bold text-xs text-emerald-200">Task Verified & Closed!</div>
                    <p className="text-[10px] text-emerald-300">Great work Rahim! UIU Green Score incremented.</p>
                  </div>
                )}
