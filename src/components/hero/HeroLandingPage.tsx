...
export const HeroLandingPage: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen bg-[#070d0b] text-slate-100 font-sans overflow-x-hidden selection:bg-emerald-500 selection:text-black">
      ...
      {/* 1. Generative Tree Background with Custom Emerald/Mint Harmonization */}
      <div className="fixed inset-0 z-0 pointer-events-none opacity-85">
        <GenerativeTree 
          ...
          saturation={1.35}    // Rich chlorophyll vibrancy
          brightness={1.06}    // Clean luminance against deep dark canvas
          speed={0.85}         // Majestic, serene branching flow
          particleAmount={1.15}
          size={1.05}
          className="w-full h-full"
        />
        {/* Harmonizing atmospheric vignette overlays */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#070d0b]/80 via-transparent to-[#070d0b] pointer-events-none" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_50%_40%,rgba(16,185,129,0.08),transparent_70%)] pointer-events-none" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_80%,rgba(52,211,153,0.06),transparent_50%)] pointer-events-none" />
      </div>

      {/* Floating Top Glass Navigation Bar */}
      <nav className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 pt-6 pb-4">
        <div className="bg-slate-950/70 backdrop-blur-xl border border-emerald-500/20 rounded-2xl px-5 py-3.5 flex items-center justify-between shadow-2xl shadow-emerald-950/40">
          ...
          <div className="hidden md:flex items-center gap-3">
            <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-950/60 border border-emerald-500/30 text-emerald-300 text-xs font-mono">
              <span className="w-2 h-2 rounded-full bg-emerald-400 animate-ping" />
              <span>16 CCTV NODES LIVE • MADANI AVE</span>
            </div>
            <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-slate-900/70 border border-slate-800 text-slate-300 text-xs font-mono">
              <MapPin className="w-3.5 h-3.5 text-teal-400" />
              <span>UIU CAMPUS GRID</span>
            </div>
          </div>
      ...
      <section className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 pt-16 pb-24 text-center">
        ...
        {/* Eyebrow Pill */}
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-950/70 border border-emerald-500/40 text-emerald-300 text-xs font-mono tracking-wide uppercase shadow-lg shadow-emerald-950/60 mb-6 backdrop-blur-md">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
          ...
          <button
            ...
            className="w-full sm:w-auto px-7 py-4 rounded-2xl bg-slate-900/80 hover:bg-slate-800/90 text-slate-200 border border-emerald-500/30 hover:border-emerald-400/60 font-semibold text-base flex items-center justify-center gap-2.5 backdrop-blur-md transition-all cursor-pointer"
          >
          ...
          <button
            ...
            className="w-full sm:w-auto px-6 py-4 rounded-2xl bg-slate-950/60 hover:bg-slate-900/80 text-slate-300 border border-slate-800 hover:border-slate-700 font-medium text-base flex items-center justify-center gap-2 backdrop-blur-md transition-all cursor-pointer"
          >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 max-w-4xl mx-auto">
          <div className="p-4 rounded-2xl bg-slate-950/70 border border-emerald-500/20 backdrop-blur-md text-center">
      ...
      {/* Feature 1: The Closed-Loop Operational Workflow */}
      <section className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 py-16 border-t border-slate-800/80">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          {/* Step 1 */}
          <div className="p-6 rounded-2xl bg-slate-950/80 border border-emerald-500/20 backdrop-blur-md relative overflow-hidden group hover:border-emerald-500/50 transition">
      ...
      {/* Feature 2: High-Impact Focus Modules with Photographic Context */}
      <section className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="group rounded-3xl bg-slate-950/80 border border-slate-800 hover:border-emerald-500/50 overflow-hidden backdrop-blur-md transition shadow-xl">
            <div className="relative h-48 overflow-hidden">
              ...
              <div className="absolute top-4 left-4 px-3 py-1 rounded-full bg-blue-950/80 border border-blue-500/40 text-blue-300 text-xs font-mono flex items-center gap-1.5">
          ...
          <div className="group rounded-3xl bg-slate-950/80 border border-slate-800 hover:border-emerald-500/50 overflow-hidden backdrop-blur-md transition shadow-xl">
            <div className="relative h-48 overflow-hidden">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/40 to-transparent" />
              <div className="absolute top-4 left-4 px-3 py-1 rounded-full bg-orange-950/80 border border-orange-500/40 text-orange-300 text-xs font-mono flex items-center gap-1.5">
          ...
          <div className="group rounded-3xl bg-slate-950/80 border border-slate-800 hover:border-emerald-500/50 overflow-hidden backdrop-blur-md transition shadow-xl">
            <div className="relative h-48 overflow-hidden">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/40 to-transparent" />
              <div className="absolute top-4 left-4 px-3 py-1 rounded-full bg-emerald-950/80 border border-emerald-500/40 text-emerald-300 text-xs font-mono flex items-center gap-1.5">
          ...
          <div className="group rounded-3xl bg-slate-950/80 border border-slate-800 hover:border-emerald-500/50 overflow-hidden backdrop-blur-md transition shadow-xl">
            <div className="relative h-48 overflow-hidden">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/40 to-transparent" />
              <div className="absolute top-4 left-4 px-3 py-1 rounded-full bg-teal-950/80 border border-teal-500/40 text-teal-300 text-xs font-mono flex items-center gap-1.5">
      ...
      {/* Bottom Launchpad Section */}
      <section className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 py-20 text-center">
        <div className="p-10 sm:p-14 rounded-3xl bg-gradient-to-b from-slate-950/90 to-emerald-950/40 border border-emerald-500/30 backdrop-blur-xl shadow-2xl shadow-emerald-950/60">
